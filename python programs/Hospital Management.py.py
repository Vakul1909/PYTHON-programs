print("""
        ================================
           Welcome to JHONSON HOSPITAL
        ================================
""")
#connection and creating database with tables
import mysql.connector as ms
pd=str(input("Enter Database Password:"))

cn=ms.connect(host="localhost",user="root",passwd="W7301@jqir#")
cur=cn.cursor()
#creating database for hospital
cur.execute("create database if not exists jhonson_hospital")
cur.execute("use jhonson_hospital")
...
#creating table for the username and password of the new user
                    ...
                    while(True):
                        ...
                        print("""
                            ...
                            3.Sign Out
                                                        ...
                                                        """)
                        # message for the task from user
...
while r!=4:
    ...
    if r==1:
      ...
      print("Thank you for using JHONSON HOSPITAL \n !!!dhanyawaad!!!")
      break
